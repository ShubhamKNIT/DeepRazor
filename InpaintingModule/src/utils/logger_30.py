...
class Logger:
    def __init__(self, log_file, ftype, checkpoint_dir):
        ...
        if self.ftype == 'train':
            self._initialize_csv(self.log_file, ['epoch', 'coarse_loss', 'rec_loss', 'adv_loss', 'percept_loss', 'fm_loss', 'gen_loss', 'disc_loss', 'gen_lr', 'disc_lr'])
        elif self.ftype == 'val':
            self._initialize_csv(self.log_file, ['epoch', 'coarse_loss', 'rec_loss', 'adv_loss', 'percept_loss', 'fm_loss', 'gen_loss', 'disc_loss', 'psnr', 'ssim', 'fid', 'lpips'])
        else:
