...
class Refine(nn.Module):
    def __init__(self):
        ...
        # Transformer Bottleneck using Swin Transformer
        self.swin_block = SwinBottleneckTransformer(embed_dim=128, num_heads=4, window_size=8, num_layers=1, mlp_ratio=4.0)
    ...
    def forward(self, img_coarse, mask):
        ...
        # Apply Swin transformer bottleneck for global context
        pl3 = self.swin_block(pl3)

        # patch extraction and attention
